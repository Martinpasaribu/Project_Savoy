        ...
        <div className=" flex flex-col px-6">
          ...
          <div className='px-2 md:px-[3rem]'>
            ...
            <div className='flex flex-col gap-4 justify-start items-start'>
              ...
              <h2 className="text-lg hp1:text-xl md:text-2xl font-medium text-[#caa25c]  mb-2 text-center">Introduction</h2>
            ...
            <div className='flex flex-col gap-4 justify-start items-start'>
              ...
              <h2 className="text-lg hp1:text-xl md:text-2xl font-medium text-[#caa25c]  mb-2 text-center">About Us</h2>

              <div className=''>
                <p className="text-left text-[11px] hp1:text-[14px] font-light text-gray-500 mb-4">
                ...
                <p className='text-left text-[11px] hp1:text-[14px] font-light text-gray-500 mb-2'>
